...
The Dreamrot is not abstract. It is happening to Zeph now. Whether it is a curse, a disease, a side effect of the bloodline, or something else entirely, understanding it is not optional. If it is the same thing that destroyed his father, he needs to know how far along he is and whether it can be stopped.
